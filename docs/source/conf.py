...
project = 'Yoda powers Library'
copyright = '2019-2020, Sebastien Ravel (CIRAD)'
github_doc_root = 'https://github.com/sravel/yoda-powers/tree/master/docs/'
issues_github_path = 'https://github.com/sravel/yoda-powers/issues'
...
html_title = "Yoda powers Library"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "Yoda powers Library"

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = './SupplementaryFiles/yoda.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = './SupplementaryFiles/yoda.png'
...
htmlhelp_basename = 'Yoda powers Library doc'
...
latex_documents = [
  ('index', 'Yoda_powers.tex', 'Documentation',
   latex_authors, 'manual', True),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = './SupplementaryFiles/yoda.png'
